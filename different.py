...
# def query_sigs(normal_list,window_number,tumor_start,tumor_len):
...
# def query_sigs_pro(normal_list,window_number,tumor_start,tumor_len):
#     for ele in normal_list[window_number]:
#         if 1 >= ele[1]/tumor_len > len_similatity or 1>= tumor_len/ele[1] > len_similatity :
#             if  tumor_start - 1000 < ele[0] < tumor_start + 1000:
#                 return True
#         if ele[1] > (1+(1-len_similatity)+0.1)*tumor_len:
#             break
...
#                         if not query_sigs(normal_sv['DEL'][chr],int(del_start/1000),del_start,del_len):
#                             print(line.strip())
...
#                             if not query_sigs_pro(normal_sv['DEL'][chr],int(del_start/1000-1),del_start,del_len):
#                                 # print(line.strip())
